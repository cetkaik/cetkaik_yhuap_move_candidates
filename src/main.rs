...
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
struct NonTam2PieceDownward {
    color: Color,
    prof: Profession,
}

#[derive(Copy, Clone, Debug, Eq, PartialEq)]
struct NonTam2PieceUpward {
    color: Color,
    prof: Profession,
}
...
fn boards() {
    ...
    let simpleBoardSample_1: PureGameState = PureGameState {
        IA_is_down: true,
        tam_itself_is_tam_hue: true,
        opponent_has_just_moved_tam: false,
        f: Field {
    ...
    let simpleBoardSample_2: PureGameState = PureGameState {
        IA_is_down: false,
        tam_itself_is_tam_hue: true,
        opponent_has_just_moved_tam: false,
        f: Field {
    ...
    let simpleBoardSample_3: PureGameState = PureGameState {
        IA_is_down: true,
        tam_itself_is_tam_hue: true,
        opponent_has_just_moved_tam: false,
        f: Field {
    ...
    let simpleBoardSample_4: PureGameState = PureGameState {
        IA_is_down: true,
        tam_itself_is_tam_hue: true,
        opponent_has_just_moved_tam: false,
        f: Field {
    ...
    let complicatedBoardSample_1: PureGameState = PureGameState {
        IA_is_down: true,
        tam_itself_is_tam_hue: true,
        opponent_has_just_moved_tam: false,
        f: Field {
    ...
    let complicatedBoardSample_2: PureGameState = PureGameState {
        IA_is_down: true,
        tam_itself_is_tam_hue: true,
        opponent_has_just_moved_tam: false,
        f: Field {
    ...
    let tamCornerSample: PureGameState = PureGameState {
        IA_is_down: true,
        tam_itself_is_tam_hue: true,
        opponent_has_just_moved_tam: false,
        f: Field {
